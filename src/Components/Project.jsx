...
import pic1 from "./imgs/webdev.gif"
import pic2 from "./imgs/android.gif"
import pic3 from "./imgs/sde.gif"
import "./style.css";

function Project() {
    return (
    <>
    <div id="comp-kr6e7f08" class="_2UdPt"></div>
    <h1 className="h1">Our Top Servies</h1>
    <h2 className="h1"><span>Our Best Services</span></h2>
    <div className="grid">
