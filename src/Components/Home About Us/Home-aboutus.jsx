              ...
              <div className="secondrowcol2">
                  ...
                  <div className="our-team-slider">
                    ...
                    {card.ourteamimages.map((image, index) => (
                      <Link to='//www.dypcoeakurdi.ac.in' target='_blank'>
                        ...
                        ${index === activeindex2 ? 'active' : index === previndex2 ? 'prev' : index === nextindex2 ? 'next' : ''}
                        ${move2 === 'left' ? 'left' : move2 === 'right' ? 'right' : ''}
                        `}
                          src={image}
                          alt="collegepic"
                          key={index}
                ...
                <div className="div2">
                  <div className="our-workshop-slider">
                    <i className="home-about-arrow left" onClick={handleprev3} />
                    {card.ourworkshopimages.map((image, index) => (
                      <Link to='//www.dypcoeakurdi.ac.in' target='_blank'>
                        ...
                        ${index === activeindex3 ? 'active' : index === previndex3 ? 'prev' : index === nextindex3 ? 'next' : ''}
                        ${move3 === 'left' ? 'left' : move3 === 'right' ? 'right' : ''}
                          `}
                          src={image}
                          alt="collegepic"
                          key={index}
                    ...
                    <i className="home-about-arrow right" onClick={handlenext3} />
                  </div>
