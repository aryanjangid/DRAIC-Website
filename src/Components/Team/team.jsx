              ...
              <article className="about-department-grid-box flow bg-black text-neutral-100 border-primary-400">
                <div className="about-department-title-body">
                  <img
                    ...
                    className="about-department-icon"
                    alt="mechdep"
                    src="https://img.icons8.com/external-vitaliy-gorbachev-fill-vitaly-gorbachev/60/ffffff/external-wrench-labour-day-vitaliy-gorbachev-fill-vitaly-gorbachev.png"
                  />
              ...
              <article className="about-department-grid-box flow bg-black text-neutral-100 border-primary-400">
                <div className="about-department-title-body">
                  <img
                    ...
                    decoding="async"
                    className="about-department-icon"
                    src="https://img.icons8.com/ios-filled/50/ffffff/electronics.png"
                    alt=""
                  />
