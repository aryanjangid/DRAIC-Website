...
const testimonials = [
  ...
  
  {
    ...
    test:"Being a DRAIC member is one of the most significant things that happened in my engineering journey. The team helped me a lot in my personal and technical development, the team was there with me in all my highs and lows. The time that I have spent here is very precious. Every project assigned to me was a journey full of knowledge and new experience.Each project, competition, event, dinner, chai break, every moment with the team is worth cherishing and I'll always look back and remember this journey as one of the best time in my life. I'll always be grateful for being a part of something so big.DRAIC made me realize that You don't build the TEAM, The Team builds YOU",
    image: Shreyash,
  },
  {
    name: "Aparna Agrawal",
    position: "Programming Department",
    test:"My journey with DRAIC family has been so enriching. I was a part of the team for 2 years and those years have taught me so much that I can proudly say that it has shaped me as a person that I am today. The project and the team work has taught me soo much in both technical and management point of view. The time in the workshop working as a team made me learn better. With the guidance of my seniors I've performed better in every stage of the projects. The friends I made and those memories will be something I'll cherish forever. The journey with draic has been a one that I'll remember when I look back at my college days.Thank you Team DRAIC 😊",
    image: Aparna,
  },
  {
